...
.form-input {
  width: 100%;
  padding: 14px 14px 14px 48px; /* Left padding for icon */
...
@media (max-width: 767px) {
  .auth-page {
    padding: 20px 15px;
    align-items: flex-start; /* Карточка ближе к верху на горизонтальном экране */
    padding-top: 40px;
  }
...
@media (max-width: 479px) {
  .auth-page {
    padding: 15px 10px;
    align-items: center; /* Центрируем по вертикали на узком экране */
    padding-top: 20px;
    padding-bottom: 20px;
  }
